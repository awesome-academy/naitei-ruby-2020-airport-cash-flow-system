...
RSpec.describe Accountmanager::SuppliersController, type: :controller do
  let(:accountmanager) {FactoryBot.create :user, role: User.roles[:accountmanager]}
  let!(:supplier_1) {FactoryBot.create :supplier, user_id: accountmanager.id}
  let!(:supplier_2) {FactoryBot.create :supplier, user_id: accountmanager.id}
  let!(:supplier_3) {FactoryBot.create :supplier, user_id: accountmanager.id}
  ...
  describe "POST suppliers#create" do
    context "with valid attributes" do
      ...
      it "should create a new supplier" do
        @new_supplier = FactoryBot.create(:supplier, user_id: accountmanager.id)
        expect {
      ...
      it "should redirect to the new supplier" do
        post :create, params: {supplier: FactoryBot.attributes_for(:supplier, sup_type: "personal")}
        expect(response).to redirect_to accountmanager_suppliers_url
      end
    end
  ...
  describe "GET #edit" do
    context "with valid id" do
      it "should render view edit" do
        get :edit, params: {id: supplier_1.id}
  ...
  describe "PUT suppliers#update/:id" do
    before :each do
      @supplier_to_update = FactoryBot.create :supplier
    end
    ...
    context "with valid attributes" do
      ...
      it "should redirect to accountmanager_suppliers_path" do
        put :update, params: {
          id: @supplier_to_update.id,
          supplier: FactoryBot.attributes_for(:supplier, sup_type: "personal")
        }
        expect(response).to redirect_to accountmanager_suppliers_path
      end
    end
    ...
    context "with invalid attributes" do
      ...
      it "should re-render accountmanager edit supplier page" do
        put :update, params: {
            id: @supplier_to_update,
            supplier: FactoryBot.attributes_for(:supplier, sup_type: "personal", taxNum: "123456")
        }
