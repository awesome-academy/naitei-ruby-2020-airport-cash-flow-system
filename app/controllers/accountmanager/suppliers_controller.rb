class Accountmanager::SuppliersController < Accountmanager::ApplicationController
  ...
  def create
    ...
    if @supplier.save
      ...
      redirect_to accountmanager_suppliers_path
    else
  ...
  def update
    ...
    if params[:sup_type].present? && @supplier.update(params)
      flash[:success] = t ".success_mess"
      redirect_to accountmanager_suppliers_path
    else
